                    ...
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h5 class="m-0">Búsqueda de matrículas</h5>
                            </div>
                            <div class="card-body">
...
@section('javascript')
    <script>
        ...
        function search() {
            ...
            axios.get(route('matricula.search'), {
                    params: {
        ...
        function modalCrear() {
            const ruta = route('matricula.create');
            axios.get(ruta)
                .then(function(respuesta) {
        ...
        function guardar() {
            // peticion a store
            const ruta = route("matricula.store");
        ...
        function modalEditar(id) {
            const ruta = route('matricula.edit', [id]);
            axios.get(ruta)
                .then(function(respuesta) {
        ...
        function actualizar(id) {
            const ruta = route('matricula.update', [id]);
        ...
        function confirmarEliminar(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const ruta = route('matricula.destroy', [id]);
