                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                <form class="form-inline" id="formulario-busqueda">
                                    ...
                                    <input type="text" class="form-control my-1 mr-sm-2" id="busqueda"
                                           name="busqueda" placeholder="">
                                    <button type="submit" class="btn btn-primary my-1">Buscar</button>
                                    <button onclick="modalCrear()" type="button"
                                            class="btn btn-success my-1 mx-1">Nuevo
                                    </button>
                                </form>
                            </div>
                        </div>
...
<?php $__env->startSection('javascript'); ?>
    <script>
        ...
        function actualizar(id) {
            const ruta = route('curso.update', [id]);
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\isicursos\resources\views/admin/curso/index.blade.php ENDPATH**/ ?>